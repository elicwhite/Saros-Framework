...
class Saros_Facebook_Api
{
	...
	*/
	protected function _graph($path, $method='GET', $params=array())
	{
		...
		{
			$e = new Saros_Facebook_Exception($result);
	...
	protected function setCookieFromSession($session=null)
	{
		...
		if (headers_sent())
		{
			...
			if (php_sapi_name() != 'cli')
				throw new Saros_Facebook_Exception('Could not set cookie. Headers already sent.');
	...
	protected function validateSessionObject($session)
	{
			...
			isset($session['sig']))
		{
			...
			if ($session['sig'] != $expected_sig)
			{
				...
				// @codeCoverageIgnoreStart
				if (php_sapi_name() != 'cli')
					throw new Saros_Facebook_Exception('Got invalid session signature in cookie.');
