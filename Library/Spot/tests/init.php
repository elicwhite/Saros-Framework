...
// Require Library_Database
$baseDir = dirname(dirname(__FILE__));
require $baseDir . '/Mapper.php';
...
$testAdapters = array(
	...
	'mongo' => array(
		'adapter' => 'Spot_Adapter_NoSQL_Mongo',
		'host' => 'localhost:28017',
		'username' => null,
		'password' => null,
		'database' => 'test',
		'options' => array('cursor' => array('timeout' => 10))
	)
);
$cli = cli_params();
 ...
 *
 */
class TestMapper extends Spot_Mapper
{
	/*
