...
abstract class Library_Database_Mapper_Abstract
{
	...
	protected $_entityClass = 'Library_Database_Entity';
	protected $_collectionClass = 'Library_Database_Entity_Collection';
	protected $_queryClass = 'Library_Database_Query';
	protected $_exceptionClass = 'Library_Database_Exception';
	...
	*/
	...
	public final function __construct(Library_Database_Adapter_Interface $adapter, $adapterRead = null)
	{
		...
		if(null !== $adapterRead)
		{
			if($adapterRead instanceof Library_Database_Adapter_Interface)
			{
				...
				throw new $this->_exceptionClass("Secondary/Slave adapter must implement 'Library_Database_Adapter_Interface'");
			}
		}
	...
	{
		if($conditions instanceof Library_Database_Entity) {
			$conditions = array(
