 ...
 */
class Library_Database_Relation_HasMany extends Library_Database_Relation_Abstract implements Countable, IteratorAggregate, ArrayAccess
{
	/**
	 * Load records with current relation data
	 *
	 * @return Library_Database_Query
	 */
	public function all()
	{
	 ...
	 *
	 * @return Library_Database_Entity
	 */
	 ...
	 *
	 * @return Library_Database_Model_ResultSet
	 */
