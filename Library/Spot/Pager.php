<?php
/**
 * Dynamic and automated pagination for Spot_Query objects
 * 
 * @package Spot
 * @link http://spot.os.ly
 * @link http://github.com/actridge/Spot
 */
class Library_Database_Pager
{
	protected $_mapper;
	protected $_query;
	protected $_page;
	 ...
	 *
	 */
	public function __construct(Library_Database_Query $query, $page = 1, $itemsPerPage = 30)
	{
