...
class CRUDTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertTrue(fixture_adapter() instanceof Library_Database_Adapter_Interface);
	}
	
	public function testMapperInstance()
	{
		$this->assertTrue($this->blogMapper instanceof Library_Database_Mapper);
	}
	...
	public function testSampleNewsUpdate()
	{
		...
		$this->assertTrue($post instanceof Library_Database_Entity);
