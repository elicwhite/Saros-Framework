...
class RelationsTest extends PHPUnit_Framework_TestCase
{
	...
	public function testBlogPostInsert()
	{
		...
		$this->assertTrue($postx instanceof Library_Database_Entity);
	...
	{
		$post = $this->blogMapper->get($postId);
		$this->assertTrue($post->comments instanceof Library_Database_Relation);
	}
	...
	public function testBlogCommentsRelationCanBeModified($postId)
	{
		...
		$this->assertTrue($sortedComments instanceof Library_Database_Query);
	}
}