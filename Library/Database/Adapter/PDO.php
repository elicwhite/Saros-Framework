 ...
 */
abstract class Library_Database_Adapter_PDO implements Library_Database_Adapter_Interface
{
    ...
    */
    public function __construct($host, $database = null, $username = null, $password = null, array $options = array())
    {
    	...
    	else
    	{
			...
			{
				throw new Library_Database_Exception($e->getMessage());
			}
    	}
    }
	...
	public function dsn()
	{
		throw new Library_Database_Exception("Error: Method " . __FUNCTION__ . " must be defined in the adapter");
	}
	 ...
	 */
	public function read(Library_Database_Query $query)
	{
	 ...
	 */
	public function toCollection(Library_Database_Query $query, $stmt)
	{
		$mapper = $query->mapper();
		if($stmt instanceof PDOStatement) {
			...
			return new Library_Database_EntitySet($results, $resultsIdentities);
